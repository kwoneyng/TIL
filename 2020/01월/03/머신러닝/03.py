...
titanic_df = pd.read_csv(r'C:\Users\PARK\Desktop\머신러닝\Main\data\titanic\train.csv')

# print('titanic 변수 type:', type(titanic_df))
    # Output : titanic 변수 type: <class 'pandas.core.frame.DataFrame'>
...
# titanic_df.info()
# 각 칼럼별 데이터 타입, null 값의 개수, 메모리 사용량 등을 출력
    # Output :
...
# print(titanic_df.describe()) 칼럼별 숫자형 데이터 값의 n-percentile 분포도, 평균값, 최대,최소값 나타냄
...
# value_counts = titanic_df['Pclass'].value_counts() Pclass 각각의 값의 개수를 출력해준다. 
# print(value_counts)
    # Output :
    # 3    491
    # 1    216
...
# 데이터 필터링 부터는 다음에~
print(titanic_df.ix[:,['Pclass', 'Name']])